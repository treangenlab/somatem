...
def main(argv):
    ...
    ete3db = os.path.join(args.databases, "reference_inference", "taxa.sqlite")
    sequences_db_f = os.path.join(args.databases, "bowtie2/bsat_ccl", "blacklist.seqs.nt.fna")
    mapping_f = os.path.join(args.databases, "reference_inference", "taxid2seqid.pickle")
    ...
    for assembly_id in downloaded_assemblies['Assembly Accession ID']:
        ...
        run_bwa(input_fasta_1, input_fasta_2, reference_fasta, assembly_id, working_directory, threads=threads)
    ...
    run_bwa(input_fasta_1, input_fasta_2, reference_fasta, 'merged', working_directory, threads=threads)
