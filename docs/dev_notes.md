...
Find the documentation for this in [readme_metromap.md](https://github.com/treangenlab/somatem-docs/blob/main/planning/pipeline_map_flowcharts/readme_metromap.md)

--- old version here (for quick reference) ---
Update: 
